...
const Create_Item = (props) => {
    const navigate = useNavigate()

    const [typeArg, setTypeArg] = useState("");
    const [nameArg, setNameArg] = useState("");
    const [dateArg, setDateArg] = useState("");
    const [amountArg, setAmountArg] = useState("");
    ...
    const create_button_clicked = async () => {
        try {
            ...
            if (local_username !== "" && local_username !== null && local_password !== "" && local_password !== null) {
                ...
                if ((typeArg !== "") && (nameArg !== "") && (dateArg !== "") && (amountArg !== "")) {
                    ...
                    try {
                        const response = await axios.post('http://127.0.0.1:5000/create_expense_list', json_post, {
                            headers: {
                        ...
                        if (res_data.toString() === "1001") {
                            ...
                            props.child_create_button_clicked(any_num)
                        }
                        else {
                            props.child_create_button_clicked(0)
                        }

                        NotificationManager.success('New expense list is created.', 'Congratulation', 3000);
    ...
    return (
        <>
            <button onClick={open_modal} className='Expense_List_div3_row_2_button'>
                Create Item
            </button>
            <Modal
            ...
            >
                <div className="Expense_List_Item_main_back_modal_div1">
                    ...
                    <div className="Expense_List_Item_main_back_modal_div1_1">
                        <button className="Expense_List_Item_main_back_modal_div1_button" onClick={create_button_clicked}>Create</button>
                    </div>
